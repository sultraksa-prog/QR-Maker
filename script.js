const allCountries = [
    // --- الدول العربية (في الأعلى لسهولة الوصول) ---
    ...
    { code: "1", flag: "🇦🇬", name: "أنتيغوا وباربودا" },
    ...
    { code: "1", flag: "🇹🇹", name: "ترينيداد وتوباغو" },
    ...
    { code: "1", flag: "🇯🇲", name: "جامايكا" },
    { code: "350", flag: "🇬🇮", name: "جبل طارق" },
    { code: "382", flag: "🇲🇪", name: "الجبل الأسود" },
    { code: "1", flag: "🇬🇩", name: "غرينادا" },
    { code: "299", flag: "🇬🇱", name: "جرينلاند" },
    { code: "236", flag: "🇨🇫", name: "جمهورية إفريقيا الوسطى" },
    { code: "420", flag: "🇨🇿", name: "التشيك" },
    { code: "1", flag: "🇩🇴", name: "جمهورية الدومينيكان" },
    { code: "243", flag: "🇨🇩", name: "جمهورية الكونغو الديمقراطية" },
    { code: "27", flag: "🇿🇦", name: "جنوب إفريقيا" },
    ...
    { code: "1", flag: "🇻🇨", name: "سانت فينسنت والغرينادين" },
    { code: "1", flag: "🇰🇳", name: "سانت كيتس ونيفيس" },
    { code: "1", flag: "🇱🇨", name: "سانت لوسيا" },
    { code: "239", flag: "🇸🇹", name: "ساو تومي وبرينسيب" },
    ...
    { code: "7", flag: "🇰🇿", name: "كازاخستان" },
    { code: "687", flag: "🇳🇨", name: "كاليدونيا الجديدة" },
